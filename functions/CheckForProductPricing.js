let CheckForProductPricing = function (ncUtil,
                                 channelProfile,
                                 flowContext,
                                 payload,
                                 callback) {
  ...
  if (!invalid) {
    ...
    try {
      ...
      // Exception Handling
      logError("Exception occurred in CheckForProductPricing - " + err, ncUtil);
      out.ncStatusCode = 500;
...
module.exports.CheckForProductPricing = CheckForProductPricing;
